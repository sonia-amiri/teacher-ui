      ...
      <el-form ref="registerFormRef" :model="registerForm" :rules="registerFormRules" label-width="80px"
        ...
        <el-form-item label="رشته" prop="roleId">
          <el-select v-model="registerForm.roleId" placeholder="لطفا رشته تحصیلی را انتخاب کنید">
            <el-option label="مدیریت سسیتم های اطلاعاتی" value="1"></el-option>
            <el-option label="مهندسی نرم افزار" value="2"></el-option>
            <el-option label="تجارت الکترونیک" value="3"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item class="btns">

          <el-button type="primary" round @click="register">ثبت نام دانشجو</el-button>
